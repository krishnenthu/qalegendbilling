...
public class TableUtility {
    public List<ArrayList<String>> get_Dynamic_TwoDimension_TablElemnts(List<WebElement> rowItems, List<WebElement> columnItems) {
        ...
        int columnSize = columnItems.size();  /** cells count** 18**/
        String[] columnList = new String[columnSize / rSize]; /** 18/6=3** columnList - size of the array**/
    ...
    public List<ArrayList<String>> getTableElements(List<WebElement> rowItems, List<WebElement> columnItems) {
